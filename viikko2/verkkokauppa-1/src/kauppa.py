...
class Kauppa:
    def __init__(self, injektoitu_varasto=default_varasto, injektoitu_pankki=default_pankki, injektoitu_viitegeneraattori=default_viitegeneraattori):
        self._varasto = injektoitu_varasto
        self._pankki = injektoitu_pankki
        self._viitegeneraattori = injektoitu_viitegeneraattori
